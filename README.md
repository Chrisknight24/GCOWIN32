...
1. **Compile source code using CmakeList.txt, first Clone [https://github.com/Chrisknight24/GCOWIN32]**: Executable app will need GCO's dll(x86 or x64), you will need to place it in a same folder with a .exe's program on windows
